...
const Footer = () => {
  return (
    <>
      <Box sx={{'@media(max-width: 820px)':{paddingBottom:"20px"}, '@media(max-width: 768px)':{paddingBottom: 0}, '@media(max-width: 540px)':{paddingTop: "20px"}, display:'flex', flexDirection: 'row', justifyContent: 'center', marginBottom: 2}}>

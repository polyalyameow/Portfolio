  ...
  return (
    ...
    <Box sx={{display: "flex", flexDirection:"row-reverse", justifyContent:"center", width: "80%", paddingTop: 5}}>
        ...
        <Box sx={{width: "54%", display: "flex", flexDirection:"column", marginRight: 3}}>
            ...
            <Button sx={{width:"40%", backgroundColor: "#533638", color: "#FFF", ":hover": {backgroundColor: "#67595E"}, alignSelf:"flex-end", marginTop:"20px"}}><Link style={{textDecoration: "none"}} to="/projects"><Typography sx={{color:"white"}}>VIEW MY WORK HERE<span className="blink">_</span></Typography></Link></Button>
        </Box>
